...
//******************(Rear wheel Actuator)********************/
int SA2A_Back = 35; //digital pin 35 of arduino to M2NA of Pololu
int SA2B_Back = 36; // digital pin 36 of arduino to M2NB of Pololu
...
int AM2A_Vertical = 36; // Digital Pin 36 of arduino to M2NA of Pololu
int AM2B_Vertical = 37; // Digital Pin 37 of arduino to M2NB of Pololu
...
pinMode(AM1B_Veritcal, OUTPUT); //M1INB
...
pinMode(CM2A, OUTPUT); // M2INA
pinMode(CM2B, OUTPUT); // M2INB
...
if(command == 'x')
{
  ...
  analogWrite(pwm_con, 0);
  }
if(command == 'c')
{
  setDirection_CON(1, CM1A, CM1B); // Forward
  analogWrite(pwm_con, 65);
  }
if(command == 'z')
{
...
setDirection_ACT(0, SA1A_Front , SA1B_Front ); // 
    ...
    setDirection_ACT(0, SA2A_Back , SA2B_Back ); //
    digitalWrite(pwm_Backsteering , HIGH);
}
...
setDirection_ACT(2, SA1A_Front , SA1B_Front ); // Retract steering actuators
    ...
    setDirection_ACT(2, SA2A_Back , SA2B_Back ); // Retract steering actuators
    digitalWrite(pwm_Backsteering , HIGH);
}
...
setDirection_ACT(1, SA1A_Front , SA1B_Front ); // Extract Front steering actuators
    ...
    setDirection_ACT(1, SA2A_Back , SA2B_Back ); // Extract Back steering actuators
    digitalWrite(pwm_Backsteering , HIGH);
}
